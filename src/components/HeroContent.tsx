    ...
    <main className="absolute bottom-8 left-8 z-20 max-w-lg">
      <div className="text-left">
        ...
        <h1 className="text-5xl md:text-6xl md:leading-16 tracking-tight font-light text-white mb-4">
          <span className="font-medium italic">Пространства</span>, которые
          <br />
          <span className="font-light tracking-tight text-white">вдохновляют жить</span>
        </h1>

        {/* Description */}
        <p className="text-xs font-light text-white/70 mb-4 leading-relaxed">
          Создаём уникальные интерьеры, отражающие вашу личность. От концепции до реализации — 
          каждая деталь продумана, каждое пространство наполнено смыслом.
        </p>
